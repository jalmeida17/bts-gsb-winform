    ...
    public class MedicineDAO
    {
        ...
        public Medicine GetByName(string name)
        {
            using (var connection = db.GetConnection())
            {
                ...
                {
                    connection.Open();
                    var command = new MySqlCommand(@"SELECT m.*, u.id_user, u.name AS user_name, u.firstname AS user_firstname, u.role AS user_role, u.email AS user_email FROM Medicine m JOIN User u ON m.id_user = u.id_user WHERE m.name = @name;", connection);
        ...
        public List<Medicine> GetByMolecule(string molecule)
        {
            ...
            using (var connection = db.GetConnection())
            {
                ...
                {
                    connection.Open();
                    var command = new MySqlCommand("SELECT * FROM Medicine WHERE molecule = @molecule;", connection);
        ...
        public void Create(Medicine medicine, int idUser)
        {
            using (var connection = db.GetConnection())
            {
                ...
                {
                    connection.Open();
                    var command = new MySqlCommand("INSERT INTO Medicine (name, molecule, dosage, description, id_user) VALUES (@name, @molecule, @dosage, @description, @id_user);", connection);
        ...
        public void Update(Medicine medicine, int idUser)
        {
            using (var connection = db.GetConnection())
            {
                ...
                {
                    connection.Open();
                    var command = new MySqlCommand("UPDATE Medicine SET name = @name, molecule = @molecule, dosage = @dosage, description = @description, id_user = @id_user WHERE id_medicine = @id;", connection);
        ...
        public void Delete(int id)
        {
            using (var connection = db.GetConnection())
            {
                ...
                {
                    connection.Open();
                    var command = new MySqlCommand("DELETE FROM Medicine WHERE id_medicine = @id;", connection);
